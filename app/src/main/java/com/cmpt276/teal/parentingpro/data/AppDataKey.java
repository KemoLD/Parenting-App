...
/**
 * this class contain key for saving and reading the data for the app
 * when need to pass a key to read or save data define here
 */
public class AppDataKey
{
    public static final String LAST_CHILD_FLIPPED_INDEX = "last_child_flipped_index";

    public static final String TEMP_LAST_FLIPPED_INDEX = "temp_last_child_flipped_index";
