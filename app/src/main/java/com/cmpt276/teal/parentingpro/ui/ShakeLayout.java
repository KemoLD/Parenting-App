...
//                    ObjectAnimator.ofFloat(shakeView.shakeImg1,"",);
    ...
    static class ShakeView {
        ...
        ShakeView(View view) {
            shakeImg1 = (ImageView)view.findViewById(R.id.shake_img1);
            shakeImg2 = (ImageView)view.findViewById(R.id.shake_img2);
            shakeImg3 = (ImageView)view.findViewById(R.id.shake_img3);
        }
    }
}
